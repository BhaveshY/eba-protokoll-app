...
const de = {
  ...
  "record.status.autoTranscribing": "Aufnahme gespeichert. Transkription startet …",
  "record.status.saveError": "Aufnahme konnte nicht gespeichert werden: {msg}",
  ...
  "notify.transcriptionStartFailed": "Transkription konnte nicht gestartet werden: {msg}",
...
const en: Dict = {
  ...
  "record.status.autoTranscribing": "Recording saved. Transcription is starting …",
  ...
  "notify.transcriptionStartFailed": "Could not start transcription: {msg}",
